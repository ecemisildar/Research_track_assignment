...
(cl:defmethod cl:initialize-instance :after ((m <RobotState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2_2022-msg:<RobotState> is deprecated: use assignment_2_2022-msg:RobotState instead.")))
...
(cl:defmethod linear_vel-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2022-msg:linear_vel-val is deprecated.  Use assignment_2_2022-msg:linear_vel instead.")
  (linear_vel m))

(cl:ensure-generic-function 'angular_vel-val :lambda-list '(m))
(cl:defmethod angular_vel-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2022-msg:angular_vel-val is deprecated.  Use assignment_2_2022-msg:angular_vel instead.")
  (angular_vel m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotState>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 linear_vel~%float32 angular_vel~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotState)))
  "Returns full string definition for message of type 'RobotState"
  (cl:format cl:nil "float32 x~%float32 y~%float32 linear_vel~%float32 angular_vel~%~%~%"))
